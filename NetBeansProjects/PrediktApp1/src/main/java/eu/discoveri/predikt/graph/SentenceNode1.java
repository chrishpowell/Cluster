 ...
 */
public class SentenceNode1 extends AbstractVertex implements Comparator<SentenceNode1>, Comparable<SentenceNode1>
{
    // Basic attrs
    ...
    // Predecessors
    @Relationship(type="PRED")
    private List<SentenceNode1>          preds = new ArrayList<>();
    // Spans
     ...
     * @param initScore 
     */
    public SentenceNode1(String name, String namespace, String origText, LangCode langCode, Locale locale, List<Token> tokens, DocumentCategory docCategory, double initScore)
    {
     ...
     * @param initScore 
     */
    public SentenceNode1(String name, String origText, LangCode langCode, Locale locale, List<Token> tokens, double initScore)
    {
     ...
     * @param initScore 
     */
    public SentenceNode1(String name, String origText, DocumentCategory docCategory, double initScore)
    {
     ...
     * @param docCategory
     */
    public SentenceNode1( String name, String origText, LangCode langCode, Locale locale, DocumentCategory docCategory  )
    {
     ...
     * @param initScore
     */
    public SentenceNode1( String name, String origText, LangCode langCode, Locale locale, DocumentCategory docCategory, double initScore )
    {
     ...
     * @param docCategory
     */
    public SentenceNode1( String name, String origText, DocumentCategory docCategory )
    {
     ...
     * @param origText Sentence text (with punctuation etc.)
     */
    public SentenceNode1( String name, String origText )
    {
    ...
    public List<SentenceNode1> getPreds() { return preds; }
    public void setPreds(List<SentenceNode1> preds) { this.preds = preds; }
...
//    }
     ...
     * @return 
     */
    public SentenceNode1 persist( SentenceNodeService ss )
    {
     ...
     * @return 
     */
    public SentenceNode1 find( SentenceNodeService ss, Long nid )
    {
        return ss.find(nid);
    }
     ...
     */
    @Override
    public int compare(SentenceNode1 s1, SentenceNode1 s2)
    {
     ...
     */
    @Override
    public int compareTo(SentenceNode1 other)
    {
    ...
    {
        final SentenceNode1 other = (SentenceNode1) obj;
