...
public class ProcessDocs
{
     ...
     */
    public static long getSentsFromTestDocs( Populate popl, SentenceNodeService sns )
            throws URISyntaxException
    {
        // Sentence count
        int totSents = 0;
...
//            Stream.Builder<List<SentenceNode>> llsn = Stream.builder();
            ...
            throws Exception
    {
        ...
        // Service for nodes
        System.out.println("... SentenceNode service setup");
        SentenceNodeService sns = new SentenceNodeService();
        // Service for counts and scores
        System.out.println("... Scoring service setup (sentence pair results)");
