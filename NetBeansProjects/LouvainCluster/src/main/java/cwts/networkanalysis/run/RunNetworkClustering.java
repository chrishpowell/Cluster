...
public final class RunNetworkClustering
{
    ...
    public static void main(String[] args)
    {
        ...
        int[][] es = network.getEdges();
        for( int ii=0; ii<es.length; ii++ )
        {
            for( int jj=0; jj<es[ii].length; jj++ )
            {
                System.out.println("[i][j]: ["+ii+"]["+jj+"]: " +es[ii][jj]);
            }
            System.out.println("");
        }
...
//        
//        System.out.println("edges0 vals:");
//        for( int ii=0; ii<edges[0].size(); ii++ )
//            System.out.print(" " +edges[0].get(ii));
//        System.out.println("");
//
//        System.out.println("edges1 vals:");
//        for( int ii=0; ii<edges[1].size(); ii++ )
//            System.out.print(" " +edges[1].get(ii));
//        System.out.println("");
